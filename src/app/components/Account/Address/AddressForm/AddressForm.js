...
export function AddressForm(props) {
  ...
  return (
    <Form onSubmit={formik.handleSubmit}>
      <Form.Input name='title' placeholder='Titulo de la dirección' value={formik.values.title} onChange={formik.handleChange} error={formik.errors.title} />
      <Form.Group widths='equal' >
        <Form.Input name='name' placeholder="Nombre y apellidos" value={formik.values.name} onChange={formik.handleChange} error={formik.errors.name} />
      ...
      <Form.Group widths='equal' >
        <Form.Input name='postal_code' placeholder="Codigo postal" value={formik.values.postal_code} onChange={formik.handleChange} error={formik.errors.postal_code} />
        <Form.Input name='phone' placeholder="Telefono" value={formik.values.phone} onChange={formik.handleChange} error={formik.errors.phone}/>
      </Form.Group>
